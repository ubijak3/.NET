...
namespace Exercise6
{
    public static class LinqTasks
    {
        ...
        {
            IEnumerable<Emp> result = Emps.Where(s => s.Job == "Backend programmer");
            return result;
        }
        ...
        public static IEnumerable<Emp> Task2()
        {
            IEnumerable<Emp> result = Emps
                                        .Where(s => s.Job == "Frontend programmer" && s.Salary > 1000)
        ...
        public static IEnumerable<object> Task7()
        {
            ...
            {
                Praca = e.Key.ToString(),
                LiczbaPracownikow = e.Count().ToString(),
            });
            return result;
        }
        ...
        {
            bool result = (Emps.Where(e => e.Job == "Backend programmer").ToList()) != null ? true : false;
            return result;
        }
        ...
        {
            IEnumerable<object> strList2 = new List<object>() { "Brak wartości", null, null};
        ...
        public static IEnumerable<object> Task11()
        {
            IEnumerable<object> result = Emps.Join(Depts,
                ...
                /*Emps.GroupBy(e => e.Deptno)
                      .Where(g => g.Count() > 1)
                      .Select(g => new { name = "x", numOfEmployees = g.Count() })
                      .ToList();*/
            return result;
        }
        ...
        {
            IEnumerable<Dept> result = null; /*Depts.Join(
                                        Emps.GroupBy(e => e.Deptno)
                                            .Where(g => g.Count() == 5 || !g.Any())
                                            .Select(g => g.Key),
                                        d => d.Deptno,
                                        e => e,
                                        (d, e) => d)
